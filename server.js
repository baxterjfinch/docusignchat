...
app.get('/has_signed/:userID', (req, res) => {get_handers.getUserHasSigned(req, res)});
...
apiClient.configureJWTAuthorizationFlow(path.resolve(__dirname, shared.PRIVATE_KEY_FILE), shared.OAUTH_BASE_URL, shared.INTEGRATOR_KEY, shared.USER_ID, shared.TOKEN_EXPIRATION_SECONDS, (err, res) => {
